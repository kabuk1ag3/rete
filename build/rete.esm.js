...
/*#__PURE__*/
function () {
  function Drag(el, button) {
    var onTranslate = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : function (_x, _y, _e) {};
    var onStart = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : function (_e) {};
    var onDrag = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : function (_e) {};
...
function (_Emitter) {
  ...
  function NodeView(node, component, emitter) {
    ...
    _this._drag = new Drag(_this.el, 0, _this.onTranslate.bind(_assertThisInitialized(_this)), _this.onSelect.bind(_assertThisInitialized(_this)), function () {
